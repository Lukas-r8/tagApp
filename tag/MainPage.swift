...
class MainPage: UIViewController{
    ...
    func setChooseCartViewTag(){
        ...
        chooseTagView.addSubview(tagLabel)
        ...
        tagLabel.leftAnchor.constraint(equalTo: chooseTagView.leftAnchor, constant: 18).isActive = true
        tagLabel.topAnchor.constraint(equalTo: chooseTagView.topAnchor, constant: 30).isActive = true
        tagLabel.widthAnchor.constraint(equalTo: chooseTagView.widthAnchor, multiplier: 1).isActive = true
        tagLabel.heightAnchor.constraint(equalToConstant: 40).isActive = true
